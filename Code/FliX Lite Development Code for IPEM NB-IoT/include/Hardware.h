...
// Application
String AppVersion = "260704"; // Internal Firmware Date Code
...
// **************** ESP32 OUTPUTS ****************
#define OPTO_OUT 25 // OPTO_OUT
#define GPO_PWM 26  // GPO_PWM
#define USER_LED 14 // USER_LED
#define RGB_LED 27  // RGB_LED

// **************** ESP32 INPUTS ****************
#define User_Button 28

// Define I2C (Expansion Port)
#define I2C_SDA 2
#define I2C_SCL 3

Adafruit_NeoPixel ws2812b(1, RGB_LED, NEO_GRB + NEO_KHZ800);
...
void ConfigureBoard()
{
  ...
  // Initialise OPTO_OUT on GP26
  pinMode(OPTO_OUT, OUTPUT);

  // Initialise RS485 UART Enable on GP23
  pinMode(ENLP, OUTPUT);

  // Initialise GPO PWM GP25
  pinMode(GPO_PWM, OUTPUT);

  // Initialise USER_LED GP14
