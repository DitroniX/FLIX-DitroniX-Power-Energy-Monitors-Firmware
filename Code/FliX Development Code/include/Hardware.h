...
float VoltageFactor = 39;                // Adjust as needed for Calculated ADC Voltage Output. Default 39
...
void CheckDCVINVoltage()
{
  ...
  if (VoltageCalculated > 5)
    Serial.print("AC > DC Voltage Input Detected. ATM90 Powered");
  if (VoltageCalculated > 35)
  {
