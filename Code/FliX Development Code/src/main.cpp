...
// E36 Using I4N Input for Current
  ...
  if (DisplayFull == true) // Display Expanded Information
  {
    PrintUnderline("Calculated RMS Power");
    Serial.println("Power V1*I1: " + String(CalculatedPowerCT1) + " W\t" + String(CalculatedPowerCT1 / 1000) + " kW");
    Serial.println("Power V2*I2: " + String(CalculatedPowerCT2) + " W\t" + String(CalculatedPowerCT2 / 1000) + " kW");
    Serial.println("Power V3*I3: " + String(CalculatedPowerCT3) + " W\t" + String(CalculatedPowerCT3 / 1000) + " kW");
  }
#if CT4_ENABLED == true && ATM90DEVICE == ATM90E36_DEVICE
  if (DisplayFull == true && EnableIPEM == true) // Display Expanded Information
  {
    Serial.println("Power V1*I4: " + String(CalculatedPowerCT4) + " W\t" + String(CalculatedPowerCT4 / 1000) + " kW");
  }
#endif
#endif
