...
#define MISO 9 // SPI MISO
#define MOSI 8 // SPI MOSI
#define SCLK 10 // SPI SCLK

#define CS_ATM 6 // SPI CS A
// #define CS_ATM 7 // SPI CS B

#define RST_ATM 4 // Joint Reset for both ATM
...
// LineFreq, PGAGain, VoltageGain1, VoltageGain2, VoltageGain3, CurrentGainCT1, 0, CurrentGainCT2
